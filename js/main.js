        ...
        async function handleAiResponse(userText) {
            ...
            setTimeout(() => {
                ...
                // 4. Identificação de Perfil: Proteção & Seguros / Blindagem
                    ...
                    response = "A blindagem patrimonial é o alicerce de qualquer estrutura de Family Office ou Holding Operacional nos EUA. Sob a liderança técnica de nosso sócio fundador Walter D'Angelo (OAB/PE 23.359), a Onebridge integra seguros internacionais de vida e saúde como ferramentas estratégicas de liquidez e sucessão familiar. <br><br>Nossa retaguarda garante que esses artefatos de proteção sejam combinados com estruturas jurídicas robustas, assegurando que o patrimônio de seus clientes VIP permaneça impenetrável perante riscos globais. <br><br>Gostaria de um resumo tático sobre como aplicamos essa camada de blindagem ou prefere agendar um briefing tático com nossos diretores?";
                }
